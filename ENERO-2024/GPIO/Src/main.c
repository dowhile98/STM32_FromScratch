...
#define BWOFFSET(BASE_ADDR, BIT)     ((BASE_ADDR - PERIPH_BASE) * 32 + BIT * 4)


#define IDR_PA0  *((volatile uint8_t *)(PERIPH_BB_BASE + BWOFFSET(GPIOA_BASE + 0x10, 0)))
#define ODR_PD15 *((volatile uint8_t *)(PERIPH_BB_BASE + BWOFFSET(GPIOD_BASE + 0x14, 15)))
