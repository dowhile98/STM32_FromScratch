...
C_SRCS += \
../Core/Components/AT_Command_parse.c \
../Core/Components/button.c 

OBJS += \
./Core/Components/AT_Command_parse.o \
./Core/Components/button.o 

C_DEPS += \
./Core/Components/AT_Command_parse.d \
...
clean-Core-2f-Components:
	-$(RM) ./Core/Components/AT_Command_parse.cyclo ./Core/Components/AT_Command_parse.d ./Core/Components/AT_Command_parse.o ./Core/Components/AT_Command_parse.su ./Core/Components/button.cyclo ./Core/Components/button.d ./Core/Components/button.o ./Core/Components/button.su
